---
description: Personal writing style for all generated text, reviews, and comments
alwaysApply: true
---

# Ghostwriter: Personal Writing Style

<!-- CUSTOMIZE: This file is for Cursor. Copy to .cursor/rules/ghostwriter.md
     in any project where you want style-matched output. Edit to match your
     personal voice. -->
